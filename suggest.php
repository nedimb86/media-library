    ...
    <form action="suggest.php" method="post">
      <table>
        ...
        <tr>
          ...
          <td>
            <select id="category" name="category">
              ...
              <option value="Musics" <?php if(isset($category) && $category == "Music") { echo "selected"; } ?>>Music</option>
            </select>
          </td>
        </tr>
        <tr>
        ...
        <tr style="display: none">
          ...
          <td><input type="text" id="address" name="address" value="<?php if(isset($address)) { echo $address; } ?>">><p>Please leave this field blank!</p></td>
        </tr>
        <tr>
